...
namespace YAML {
	...
	template<> 
	struct ROBOTRACONTEUR_COMPANION_INFOPARSER_API convert<com::robotraconteur::pointcloud::sensor::PointCloudPartSensorDataPtr>{
	...
	template<> 
	struct ROBOTRACONTEUR_COMPANION_INFOPARSER_API convert<com::robotraconteur::pointcloud::sensor::PointCloud2SensorDataPtr>{
	...
	template<> 
	struct ROBOTRACONTEUR_COMPANION_INFOPARSER_API convert<com::robotraconteur::pointcloud::sensor::PointCloud2PartSensorDataPtr>{
